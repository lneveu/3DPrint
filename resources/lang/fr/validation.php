...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'model' => [
            'required' => 'Veuillez saisir un modèle.',
        ],
        'annee' => [
            'required' => 'Veuillez saisir une année.',
        ],
        'description' => [
            'required' => 'Veuillez saisir une description.',
        ],
        'fuel' => [
            'required' => 'Veuillez saisir un carburant.',
        ],
        'gearbox' => [
            'required' => 'Veuillez saisir une boîte de vitesse.',
        ],
        'price' => [
    ...
    */
    ...
    'attributes' => [
        ...
        "size" => "Taille",
        "picture" => "photo",
        "brand1" => "de la première marque",
        "brand2" => "de la deuxième marque",
        "brand3" => "de la troisième marque",
        "brand" => "Marque",
        "model" => "Modèle",
        "annee" => "Année",
        "fuel" => "Carburant",
